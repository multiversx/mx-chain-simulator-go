...
require (
	...
	github.com/multiversx/mx-chain-go/sovereignnode v1.8.10-0.20250203113753-965f50cec0b4
...
require (
	...
	github.com/multiversx/mx-chain-es-indexer-go v1.7.16-0.20250129123355-f4edef3b60fb // indirect
