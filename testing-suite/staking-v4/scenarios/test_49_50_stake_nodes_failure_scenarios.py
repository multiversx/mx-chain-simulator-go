...
def test_49_50_stake_nodes_failure_scenarios(blockchain, epoch):
        # === PRE-CONDITIONS ==============================================================
        ...
        # BEGIN #########################################################################
        # THIS CODE IS COMMENTED BECAUSE AFTER MULTIPLE TRIES IT IS NOT POSSIBLE TO TEST ON CHAIN SIMULATOR
